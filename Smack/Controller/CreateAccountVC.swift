...
class CreateAccountVC: UIViewController {
    ...
    func setupView() {
        ...
        passTxt.attributedPlaceholder = NSAttributedString(string: "password", attributes: [NSAttributedStringKey.foregroundColor: SMACK_PURPLE_PLACE_HOLDER])
